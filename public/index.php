...
<div class="container-fluid heading inverter py-5">
  <div class="container py-5">
    <div class="row">
      <div class="col-md-6">
        <img src="./imagens/retrospectiva.png" alt="retro" class="img-fluid">
      </div>
      <div class="col-md-6">
        <h4>RETROSPECTIVA 2020</h4>
        <h2 class="py-3">Veja o que rolou no seu Spotify</h2>
        <h6 class="pb-3">
...
<div class="container-fluid inverter banner">
  <div class="container py-5">
    <div class="row">
      <div class="col-md-5">
        <h4 class="py-4">SPOTIFY FREE</h4>
